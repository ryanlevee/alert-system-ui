...
const MapComponent: React.FC = () => {
    ...
    // Corrected handleCategoryChange and handleEventTypeChange to match react-select onChange type
    const handleCategoryChange = useCallback(
        (newValue: SingleValue<{ value: string; label: string; }>, actionMeta: ActionMeta<{ value: string; label: string; }>) => {
            ...
            // if (newValue?.value === heatmapCategory) { // Check if the new value is the same as the current value
            //     return; // Do nothing if the same category is selected
            // }
            // setHeatmapEventType(null);
        },
    ...
    // const availableEventTypes = React.useMemo(() => {
    //     if (!heatmapCategory) return []; // Return empty array if no category selected
        ...
        <div className="map-container">
            ...
            <MapContainer center={center as LatLngExpression} zoom={zoomLevel} >
                ...
                <LayersControl position="topright">
                    ...
                    >
                        <LayerGroup>
                            {renderMarkers(defaultZIndexOffset, hoverZIndexOffset)}
                        </LayerGroup>
                    </LayersControl.Overlay>
